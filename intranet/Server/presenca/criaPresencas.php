		...
		foreach($cert_data as $certificadoDados) {
				...
				if(!$db->existe('es_certificados',array('cpf'=> $InscritoDados->cpf, 'fgk_tipo'=>$certificadoDados->id_tipo_certificado ))){
					...
					$texto_email="
						...
						Prezado(a),<br>Agradecemos a sua participação no ".$sigla_evento_atual.".<br>Segue o link para baixar o seu certificado:<br><br>http://www.encontrodesaberes.ufop.br/gerar_certificado.php?c=".$certificado->chave_autenticidade."&f=1<br><br>Atenciosamente,<br>Comissão organizadora.";
