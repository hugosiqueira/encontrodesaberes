...
foreach ($_POST as $campo => $valor) { $$campo = trim(strip_tags($valor));}
  try {
        ...
        $stmt = $db->atualizar('es_avaliacao', $dados, 'id', $id_avaliacao);
        if(!$stmt){
          echo "Não foi possível inserir o resultado final";
          exit();
        }
       ...
       if($resultado_final == 'A')
          $fgk_status = 14;
        else if($resultado_final == 'R')
          $fgk_status = 15;

        $stmt2 = $db->atualizar('es_trabalho', array('fgk_status'=>$fgk_status, 'datahora_ultima_atualizacao'=>date('Y-m-d H:i:s')), 'id', $fgk_trabalho);

        if(!$stmt2){
          echo "Não foi possível atualizar o status do trabalho";
          exit();
        }
        ...
        if($resultado_final == "A"){
          if($parecer ==""){
            $corpo_mensagem = '<p>Prezado(a) '. $autores->nome . ',</p>
                                    ...
                                    <p>Foi ACEITO para apresentação no Encontro de Saberes.</p>
                                    <p>Atenciosamente</p>
                                    <p>--</p>
          ...
          $corpo_mensagem = '<p>Prezado(a) '. $autores->nome . ',</p>
                                  ...
                                  <p>NÃO FOI ACEITO para apresentação no Encontro de Saberes.</p>
                                  <p>Atenciosamente</p>
                                  <p>--</p>
                                  <p>Coordenação do Encontro de Saberes<br>
                                    Centro de Artes e Convenções da UFOP<br>
  ...
  <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
   ...
   $url = 'https://api.sendgrid.com/';
            ...
            $params = array(
                ...
                'to'        => '$autores->email',
                'subject'   => 'Encontro de Saberes - Parecer Final',
                'html'      => $mensagem,
                'text'      => $corpo_mensagem,
           ...
           $dados_email= array('fgk_evento'=>EVENTO_ATUAL,
                    ...
                    'categoria'=> 'Parecer Final',
                    'assunto'=>'Encontro de Saberes - Parecer Final',
