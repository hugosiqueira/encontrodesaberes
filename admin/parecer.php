...
<style>
    ...
    <div class="page-inner">
        ...
        <div id="main-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                 <?php  if((TIPO_USUARIO  == ADMINISTRADOR || AREA_COORDENACAO != 8)  && (DATA_PARECER_INI <= date('Y-m-d H:i:s')) && (DATA_PARECER_FIM >= date('Y-m-d H:i:s'))){ ?>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class='form-control' id='alocados' name='alocados' required>
                                            <option></option>
                                            <option value="0">Sem Parecer - Não Avaliados</option>
                                            <option value="1">Sem Parecer - Avaliado por 1 revisor</option>
                                            <option value="2">Sem Parecer - Avaliado pelos 2 revisores</option>
                                            <option value="3">Parecer Emitido - Aprovados com Restrições</option>
                                            <option value="4">Parecer Emitido - Aprovados ou Reprovados</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-7">
                                        ...
                                        <button class="btn btn-warning myButton" id="aprovar_restricao">Aprovar com Restrições</button>
                                        ...
                                        <table id="resumo" class="table table-striped table-bordered display select" style="width:99%">
                                            <?php
                                            if (TIPO_USUARIO == ADMINISTRADOR) {
                                                $stmt = $db->sql_query('Select es_avaliacao.id, es_avaliacao.fgk_trabalho, es_avaliacao.status, es_avaliacao.nota, es_avaliacao.parecer, es_avaliacao.parecer_ar, es_avaliacao.resultado, es_avaliacao.bool_caint,
                                                                        ...
                                                                        WHERE es_trabalho.fgk_status > 2 AND es_trabalho.fgk_evento = '.EVENTO_ATUAL);
                                            } else {
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($stmt as $resumo) {
                                                    ...
                                                    if ($resumo->status == 0)
                                                        $imagem_avaliado = "<img class = 'img-responsive' src='assets/images/icons/icon_aguarde.png' data-toggle='tooltip' title='$resumo->avaliacao_status_descricao' alt='$resumo->avaliacao_status_descricao' >";

                                                    else if ($resumo->status == 1)
                                                        $imagem_avaliado = "<img class = 'img-responsive' src='assets/images/icons/icon_aguarde.png' data-toggle='tooltip' title='$resumo->avaliacao_status_descricao' alt='$resumo->avaliacao_status_descricao' >";

                                                    else if ($resumo->status == 2)
                                                        $imagem_avaliado = "<img class = 'img-responsive' src='assets/images/icons/icon_ok_alert.png' data-toggle='tooltip' title='$resumo->avaliacao_status_descricao' alt='$resumo->avaliacao_status_descricao' >";
                                                    else if($resumo->status == 3)
                                                        $imagem_avaliado = "<img class = 'img-responsive' src='assets/images/icons/icon_ok.png' data-toggle='tooltip' title='$resumo->avaliacao_status_descricao' alt='$resumo->avaliacao_status_descricao' >";
                                                    else if($resumo->status == 4)
                                                        $imagem_avaliado = "<img class = 'img-responsive' src='assets/images/icons/icon_ok.png' data-toggle='tooltip' title='$resumo->avaliacao_status_descricao' alt='$resumo->avaliacao_status_descricao' >";
                                                    
                                                    
                                                   if($resumo->status == 3 || $resumo->status == 4){
                                                        if($resumo->resultado == 'A')
                                                            echo '<tr><td><span class="label label-success myButton2" style="font-size: 15px;">'.$resumo->resultado.'</td>';
                                                        else if($resumo->resultado == 'AR')
                                                            echo '<tr><td><span class="label label-warning myButton2" style="font-size: 15px;">'.$resumo->resultado.'</td>';
                                                        else if($resumo->resultado == 'R')
                                                            echo '<tr><td><span class="label label-danger myButton2" style="font-size: 15px;">'.$resumo->resultado.'</td>';
                                                    } else if(($resumo->status == 2 || $resumo->status ==1)  ){
                                                       echo '<td><input type="checkbox" name="id_avaliacao" id="id_avaliacao'.$i.'" value="'.$resumo->id.'" /></td>'; 
                                                    } else { 
                                                        echo "<td></td>";
                                                     }
                                                    echo '
                                                            ...
                                                            <td align="left"><a href="cadastrar_parecer.php?id=' . $resumo->id. '">' . $resumo->trabalho_titulo . '</a></td>
                                                            ...
                                                            <td><span style="display:none">' . $resumo->status . '</span></td>
    ...
    <?php } else {
        echo " <div class='panel-body'>Não estamos no período de emissões de pareceres.<br> Início: " . date('d/m/Y - H:i:s', strtotime(DATA_PARECER_INI)) . "<br>Fim: " . date('d/m/Y - H:i:s', strtotime(DATA_PARECER_FIM)) . " </div>";
    }
     ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#aprovar_restricao').on( 'click', function () {
                ...
                $("input[name='id_avaliacao']:checked").each(function(){
                    ...
                    $.post('a_avaliacao.php', {
                            id_avaliacao:$(this).val(), resultado:'AR'}, 
                            function(resposta) {
                                if (resposta == "sucesso") {
                                    // Exibe o erro na div
