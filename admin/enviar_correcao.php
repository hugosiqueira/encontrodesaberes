...
$datahora_registro = date('Y-m-d H:i:s');
  ...
  try {
        ...
        $dados = array(
			'titulo_revisado' => $titulo,
            'palavras_chave_revisado'=> $palavras_chave,
            'resumo_revisado' => $resumo,
            'fgk_status' => $fgk_status,
            'datahora_ultima_atualizacao' => $datahora_registro
        );

        $db->atualizar('es_trabalho', $dados, 'id', $id_trabalho);
                                        ...
                                        <table class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="600">
                                          <tbody><tr>
                                            ...
                                            <td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top">
                                              ...
                                              <h3>Correção submetida com sucesso.</h3>
                                              <p>Prezado(a),<br>
                                              <p>Agradecemos pela correção de trabalho para o Encontro de Saberes. </p>
          ...
          ';
            $mensagem_text = 'Correção submetida com sucesso.
                        Prezado(a),
                        Agradecemos pela correção de seu trabalho para o Encontro de Saberes UFOP.
            ...
            $params = array(
                ...
                'to'        => EMAIL_USUARIO,
                'subject'   => 'Encontro de Saberes - Correção de trabalho submetida',
                'html'      => $mensagem,
                'text'      => $mensagem_text,
            ...
            $dados_email= array('fgk_evento'=>EVENTO_ATUAL,
                    ...
                    'categoria'=> 'Correção Submetida',
                    'assunto'=>'Encontro de Saberes - Correção de trabalho submetida',
