  ...
  try {
    ...
    if($db->existe('es_trabalho_caint', array('cpf' => CPF_USUARIO, 'fgk_evento'=>EVENTO_ATUAL )) ){
        ...
        $dados = array(
            ...
            'periodo_cursava' => $periodo_cursava,
            'tempo_afastamento' => $tempo_afastamento,
            'tipo_mobilidade' => $tipo_mobilidade,
            'universidade_destino' => $universidade_destino,
            'cidade_destino' => $cidade_destino,
            'pais_destino' => $pais_destino,
            'curso_destino' => $curso_destino,
            'curso_area_destaque' => $curso_area_destaque, 
            'questoes_linguisticas' =>$questoes_linguisticas,
            'tipo_moradia' => $tipo_moradia,
            'sistema_avaliacao' => $sistema_avaliacao,
            'dinamica_metodologia_aulas' => $dinamica_metodologia_aulas,
            'custo_vida' => $custo_vida,
            'infra_universidade' => $infra_universidade,
            'servico_acolhimento' => $servico_acolhimento,
            'estagio' => $estagio,
            'atividades_universidade' => $atividades_universidade,
            'processo_adaptacao' => $processo_adaptacao,
            'relato_pessoal' => $relato_pessoal,
            'conselhos_calouro' => $conselhos_calouro,
            'datahora_submissao' => $datahora_submissao,
            'datahora_ultima_atualizacao' => date('Y-m-d H:i:s')
            );
    
        $stmt = $db->atualizar('es_trabalho_caint', $dados, 'id', $id_trabalho_caint); 
        if(!$stmt)
            echo "Erro ao atualizar o trabalho";
        else {
            if($fgk_status == TRABALHO_SUBMETIDO){
                              ...
                              <table class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="600">
                                <tbody><tr>
                                  ...
                                  <td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top">
                                    ...
                                    <p>Prezado(a) '.$nome_aluno.',<br>
                                    <p>Recebemos o seu trabalho científico para o Encontro de Saberes UFOP . </p>
...
';
            $mensagem_text = 'Prezado(a) '.$nome_aluno.',
                         Recebemos o resumo do seu trabalho científico para o Encontro de Saberes UFOP .
        ...
        $stmt = $db->inserir('es_trabalho_caint', $dados); 
        if($fgk_status == 2){
...
';
            $mensagem_text = 'Prezado(a) '.$nome_aluno.',
                         Recebemos o resumo do seu trabalho científico para o encontro de saberes .
                        Fique atento aos prazos para edição do trabalho em sua área restrita no site.
                        Atenciosamente,
                        Encontro de Saberes';
            ...
            $json_string = array(
              'category' => 'Trabalho de Mobilidade Submetido'
            );
            ...
            $dados_email= array('fgk_evento'=>EVENTO_ATUAL,
                    ...
                    'categoria'=> 'Trabalho de mobilidade',
                    'assunto'=>'Encontro de Saberes - Trabalho de mobilidade submetido',
