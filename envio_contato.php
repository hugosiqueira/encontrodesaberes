            ...
            <td class="mcnTextBlockInner" valign="top">
                ...
                <table class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="600">
                    <tbody><tr>
						...
						<h3>Mensagem pedindo informação no site:</h3>
                ...
                <table class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="600">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top">
                            ...
                            <em>Copyright © 2015 Universidade Federal de Ouro Preto</em><br>
<br>
&nbsp;
                        </td>
                    </tr>
...
';
$mensagem_text = 'Mensagem pedindo informação no site:
...
try {
	...
	$json_string = array(
	  ...
	  'to' => array(
	    "encontrodesaberes@ufop.br"
	  ),
	  'category' => 'formulario de contato'
	);
  ...
  <strong>Obrigado!</strong> Seu e-mail foi enviado com sucesso. Aguarde nosso retorno.
</div>';
} catch(PDOException $e) {
    echo '<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Desculpe-nos!</strong> Ocorreu um erro ao enviar o seu e-mail. Tente novamente mais tarde.
</div>';
